...
const VoucherTableRow = ({record:{id,cost,quantity,product:{title,price}},index}) => {
    ...
    <td className='px-6 py-4  text-end '>
    <button onClick={handleDelete} className="record-del group-hover:opacity-100 group-hover:pointer-events-auto duration-200   pointer-events-none opacity-0  top-3 p-3 active:scale-75 bg-blue-100  rounded-lg">
